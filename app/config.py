...
class Settings(BaseSettings):
    ...
    # LOCAL_TOOLS is now 19 (read_document, read_image, edit_excel and
    # nepali_date all landed after that measurement). Serialising those same 15
    # schemas today gives 15,498 chars, so the measurement calibrates to ~4.46
    # chars/token; all 19 serialise to ~21,540 chars, i.e. **~4830 tokens
    # estimated**. Raised 4000 -> 4600 -> 4900 on that basis (2026-08-29): the
    ...
    # tokenizes differently from qwen2.5). At 19 tools this is ~15% of the
    ...
    # every addition.
    context_tool_schema_tokens: int = 4900
